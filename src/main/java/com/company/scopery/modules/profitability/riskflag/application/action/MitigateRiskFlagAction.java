...
public class MitigateRiskFlagAction {
    ...
    public ProfitRiskFlagResponse execute(UUID projectId, UUID riskFlagId) {
        ...
        try {
            return ProfitRiskFlagResponse.from(riskFlags.save(existing.mitigate()));
