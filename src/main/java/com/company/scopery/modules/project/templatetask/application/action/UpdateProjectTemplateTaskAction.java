...
@Component
public class UpdateProjectTemplateTaskAction {
    ...
    public UpdateProjectTemplateTaskAction(ProjectTemplateRepository templateRepository,
    ...
    @Transactional
    public ProjectTemplateTaskResponse execute(UpdateProjectTemplateTaskCommand cmd) {
        ...
        ProjectTemplateTask saved = taskRepository.save(task.update(
                cmd.templatePhaseId(),
                cmd.templateWbsNodeId(),
                cmd.code(),
                cmd.title(),
                cmd.description(),
                priority != null ? priority : task.defaultPriority(),
                cmd.estimateHours(),
                cmd.dueOffsetDays(),
                cmd.startOffsetDays(),
        ...
        activityLogger.logSuccess(
                ...
                saved.id(),
                ProjectActivityActions.UPDATE_PROJECT_TEMPLATE_TASK,
                "Template task updated: " + saved.title()
        );
