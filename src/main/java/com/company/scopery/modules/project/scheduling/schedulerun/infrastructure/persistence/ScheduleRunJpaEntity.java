...
public class ScheduleRunJpaEntity extends AuditableJpaEntity {
    ...
    @Column(name="input_summary_json", columnDefinition="jsonb") private String inputSummaryJson;
    @Column(name="result_summary_json", columnDefinition="jsonb") private String resultSummaryJson;
