...
@Component
public class DeactivatePhaseDefinitionAction {
    ...
    public DeactivatePhaseDefinitionAction(PhaseDefinitionRepository repository,
    ...
    @Transactional
    public PhaseDefinitionResponse execute(DeactivatePhaseDefinitionCommand command) {
        ...
        PhaseDefinition saved = repository.save(pd.deactivate());

        platformPublisher.enqueuePhaseDefinition(saved, "PHASE_DEFINITION_DEACTIVATED");

        activityLogger.logSuccess(
                ProjectEntityTypes.PHASE_DEFINITION,
                saved.id(),
                ProjectActivityActions.DEACTIVATE_PHASE_DEFINITION,
                "Phase definition deactivated: " + saved.code()
        );
