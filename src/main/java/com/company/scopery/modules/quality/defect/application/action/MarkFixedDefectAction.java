...
@Component
public class MarkFixedDefectAction {
    private final DefectRepository repo;
    private final QualityAuthorizationService authorization;
    private final CurrentUserAuthorizationService currentUser;
    private final QualityActivityLogger activityLogger;
    public MarkFixedDefectAction(DefectRepository repo, QualityAuthorizationService authorization,
    ...
    public DefectResponse execute(UUID projectId, UUID defectId) {
        ...
        var saved = repo.save(d.markFixed(actor.id()));
        activityLogger.logSuccess(QualityEntityTypes.DEFECT, saved.id(), QualityActivityActions.DEFECT_FIXED, "Defect marked fixed");
