...
public class TestCasePersistenceMapper {
    public TestCase toDomain(TestCaseJpaEntity e) {
        return new TestCase(e.getId(), e.getProjectId(), e.getTestSuiteId(), e.getUseCaseId(), e.getCode(), e.getTitle(), e.getDescription(),
                ...
                e.getArchivedAt(), e.getArchivedBy(), e.getAssigneeId(),
                e.getAutomationStatus() != null ? AutomationStatus.valueOf(e.getAutomationStatus()) : AutomationStatus.MANUAL,
                e.getVersion()==null?0:e.getVersion(), e.getCreatedAt(), e.getUpdatedAt());
    }
    public TestCaseJpaEntity toJpaEntity(TestCase d) {
        TestCaseJpaEntity e = new TestCaseJpaEntity();
        e.setId(d.id()); e.setProjectId(d.projectId()); e.setTestSuiteId(d.testSuiteId()); e.setUseCaseId(d.useCaseId()); e.setCode(d.code());
        ...
        e.setAssigneeId(d.assigneeId());
        e.setAutomationStatus(d.automationStatus() != null ? d.automationStatus().name() : AutomationStatus.MANUAL.name());
