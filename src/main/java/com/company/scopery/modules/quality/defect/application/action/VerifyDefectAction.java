...
@Component
public class VerifyDefectAction {
    private final DefectRepository repo;
    private final QualityAuthorizationService authorization;
    private final CurrentUserAuthorizationService currentUser;
    private final QualityActivityLogger activityLogger;
    public VerifyDefectAction(DefectRepository repo, QualityAuthorizationService authorization,
    ...
    public DefectResponse execute(UUID projectId, UUID defectId) {
        ...
        var saved = repo.save(d.verify());
        activityLogger.logSuccess(QualityEntityTypes.DEFECT, saved.id(), QualityActivityActions.DEFECT_VERIFIED, "Defect verified");
