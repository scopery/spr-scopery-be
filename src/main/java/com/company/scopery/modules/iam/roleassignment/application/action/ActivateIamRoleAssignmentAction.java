...
@Component
public class ActivateIamRoleAssignmentAction {
    ...
    public ActivateIamRoleAssignmentAction(IamRoleAssignmentRepository assignmentRepository,
    ...
    @Transactional
    public IamRoleAssignmentResponse execute(ActivateIamRoleAssignmentCommand command) {
