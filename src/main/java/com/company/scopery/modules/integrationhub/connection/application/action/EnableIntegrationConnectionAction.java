...
@Component
public class EnableIntegrationConnectionAction {
    private final IntegrationConnectionRepository connections;
    private final IntegrationAuthorizationService auth;
    private final IntegrationActivityLogger activity;
    public EnableIntegrationConnectionAction(IntegrationConnectionRepository connections,
    ...
    public IntegrationConnectionResponse execute(UUID workspaceId, UUID connectionId) {
        ...
        var saved = connections.save(c.activate());
        activity.logSuccess("INTEGRATION_CONNECTION", saved.id(), "INTEGRATION_CONNECTION_ENABLED", "Connection enabled");
