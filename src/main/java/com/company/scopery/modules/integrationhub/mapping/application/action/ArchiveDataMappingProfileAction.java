...
@Component
public class ArchiveDataMappingProfileAction {
    ...
    public ArchiveDataMappingProfileAction(DataMappingProfileRepository profiles,
    ...
    @Transactional
    public DataMappingProfileResponse execute(UUID workspaceId, UUID profileId) {
        ...
        activity.logSuccess("INTEGRATION_MAPPING_PROFILE", saved.id(), "INTEGRATION_MAPPING_PROFILE_ARCHIVED", "Mapping profile archived");
