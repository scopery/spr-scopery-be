...
public final class ElicitationApiPaths {
    ...
    public static final String GENERATE_QUESTIONS       = "/api/v1/projects/{projectId}/elicitation-sessions/{sessionId}/generate-questions";
    public static final String EVALUATE_ANSWERS         = "/api/v1/projects/{projectId}/elicitation-sessions/{sessionId}/evaluate-answers";
    ...
    public static final String ROUND_SUBMIT     = "/api/v1/elicitation-rounds/{roundId}/submit";
