...
public class Provider {
    ...
    private Provider(UUID id, String name, ProviderCode code, String type,
    ...
    public static Provider create(String name, ProviderCode code, String type,
    ...
    public static Provider reconstitute(UUID id, String name, ProviderCode code, String type,
                                        String apiBaseUrl, String description, ProviderStatus status,
                                        Instant createdAt, Instant updatedAt) {
        return new Provider(id, name, code, type, apiBaseUrl, description, status, createdAt, updatedAt);
    }

    public void update(String name, String type, String apiBaseUrl, String description) {
        validateName(name);
        validateType(type);
