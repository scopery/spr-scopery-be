...
@Component
public class SetDefaultModelDeploymentAction {

    private final ModelDeploymentRepository deploymentRepository;
    private final AiModelRepository aiModelRepository;
    private final AiAgentActivityLogger activityLogger;

    public SetDefaultModelDeploymentAction(ModelDeploymentRepository deploymentRepository,
    ...
    @Transactional
    public ModelDeploymentDetailResponse execute(SetDefaultModelDeploymentCommand command) {
