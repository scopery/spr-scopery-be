...
import com.company.scopery.modules.aiagent.execution.application.command.CancelExecutionCommand;
...
public class CancelExecutionAction {
    ...
    public CancelExecutionAction(ExecutionLogRepository executionLogRepository,
    ...
    @Transactional
    public ExecutionLogDetailResponse execute(CancelExecutionCommand command) {
