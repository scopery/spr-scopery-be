...
@Component
public class CreateClarificationAction {
    ...
    public CreateClarificationAction(SpecPackAgentSessionRepository sessionRepository,
    ...
    @Transactional
    public ClarificationResponse execute(CreateClarificationCommand command) {
        ...
        activityLogger.logSuccess(
                ...
                "Clarification created: " + saved.code()
        );
