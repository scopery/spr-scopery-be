...
import com.company.scopery.modules.notification.advanced.reminder.application.command.SnoozeReminderInstanceCommand;
...
@Component
public class SnoozeReminderInstanceAction {
    ...
    public SnoozeReminderInstanceAction(ReminderInstanceRepository instances, CurrentUserAuthorizationService currentUser, WorkspaceIamIntegrationService iam) {
        this.instances=instances; this.currentUser=currentUser; this.iam=iam;
    }
    @Transactional
    public ReminderInstanceResponse execute(SnoozeReminderInstanceCommand c) {
        ...
        return ReminderInstanceResponse.from(instances.save(instance.snooze(c.snoozedUntil())));
    }
}
