...
@Component
public class TriagePrivacyRequestAction {
    private final PrivacyRequestRepository repo;
    private final TrustAuthorizationService auth;
    public TriagePrivacyRequestAction(PrivacyRequestRepository repo, TrustAuthorizationService auth) {
    ...
    public PrivacyRequestResponse execute(UUID workspaceId, UUID requestId) {
        ...
        try { return PrivacyRequestResponse.from(repo.save(req.triage())); }
