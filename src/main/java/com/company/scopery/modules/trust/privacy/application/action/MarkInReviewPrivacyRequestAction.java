...
@Component
public class MarkInReviewPrivacyRequestAction {
    private final PrivacyRequestRepository repo;
    private final TrustAuthorizationService auth;
    public MarkInReviewPrivacyRequestAction(PrivacyRequestRepository repo, TrustAuthorizationService auth) {
    ...
    public PrivacyRequestResponse execute(UUID workspaceId, UUID requestId) {
        ...
        try { return PrivacyRequestResponse.from(repo.save(req.markInReview())); }
