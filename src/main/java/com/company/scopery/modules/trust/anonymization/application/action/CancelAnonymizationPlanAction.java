...
@Component
public class CancelAnonymizationPlanAction {
    private final AnonymizationPlanRepository repo;
    private final TrustAuthorizationService auth;
    public CancelAnonymizationPlanAction(AnonymizationPlanRepository repo, TrustAuthorizationService auth) {
    ...
    public AnonymizationPlanResponse execute(UUID workspaceId, UUID planId) {
        ...
        return AnonymizationPlanResponse.from(repo.save(plan.cancel()));
    }
}
