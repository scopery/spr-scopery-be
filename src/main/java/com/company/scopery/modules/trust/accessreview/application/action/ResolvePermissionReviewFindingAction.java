...
@Component
public class ResolvePermissionReviewFindingAction {
    private final PermissionReviewFindingRepository repo;
    private final TrustAuthorizationService auth;
    public ResolvePermissionReviewFindingAction(PermissionReviewFindingRepository repo, TrustAuthorizationService auth) {
    ...
    public PermissionReviewFindingResponse execute(UUID workspaceId, UUID findingId) {
        ...
        return PermissionReviewFindingResponse.from(repo.save(f.resolve()));
    }
}
