 ...
 * with EXPLAIN_PAGE response mode.
...
public class ExplainPageAction {
    ...
    public ExplainPageAction(AiConversationRepository conversationRepository,
    ...
    public AiSseStartResponse execute(ExplainPageCommand cmd) {
        ...
        activityLogger.logSuccess(
                ...
                saved.id(),
                AiAssistantActivityActions.EXPLAIN_PAGE,
                "Explain page requested for: " + cmd.pageCode()
        );
