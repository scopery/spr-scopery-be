 ...
 * with EXPLAIN_DISABLED_ACTION response mode.
 * Full guide-flow orchestration is deferred — this action returns a placeholder response.
 */
@Component
public class ExplainDisabledActionAction {

    private final AiConversationRepository conversationRepository;
    private final AiAssistantActivityLogger activityLogger;

    public ExplainDisabledActionAction(AiConversationRepository conversationRepository,
    ...
    @Transactional
    public AiSseStartResponse execute(ExplainDisabledActionCommand cmd) {
        AiConversation conv = AiConversation.create(
                ...
                null,
                "Explain Disabled Action: " + cmd.pageCode() + "." + cmd.actionCode()
        );
        ...
        activityLogger.logSuccess(
                ...
                saved.id(),
                AiAssistantActivityActions.EXPLAIN_DISABLED_ACTION,
                "Explain disabled action requested for: " + cmd.pageCode() + "." + cmd.actionCode()
        );
