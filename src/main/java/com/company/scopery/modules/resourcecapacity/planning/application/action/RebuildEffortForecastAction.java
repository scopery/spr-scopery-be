...
@Component
public class RebuildEffortForecastAction {
    ...
    public RebuildEffortForecastAction(ResourcePlanningRebuildService rebuild, ProjectRepository projects,
    ...
    @Transactional
    public EffortForecastResponse execute(UUID projectId) {
        ...
        var result = rebuild.rebuildForecast(project.workspaceId(), projectId);
        activity.logSuccess(CapacityEntityTypes.EFFORT_FORECAST, projectId, CapacityActivityActions.EFFORT_FORECAST_REBUILT, "Forecast rebuilt");
        return result;
    }
}
