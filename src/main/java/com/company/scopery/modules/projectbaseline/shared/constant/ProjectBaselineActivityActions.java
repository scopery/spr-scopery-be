...
public final class ProjectBaselineActivityActions {
    public static final String PROJECT_BASELINE_CREATED = "PROJECT_BASELINE_CREATED";
    public static final String PROJECT_BASELINE_UPDATED = "PROJECT_BASELINE_UPDATED";
    ...
    private ProjectBaselineActivityActions() {}
}
