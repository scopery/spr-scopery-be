...
@Component
public class UpdateQuoteLineAction {
    ...
    public UpdateQuoteLineAction(QuoteVersionRepository versions, QuoteLineRepository lines,
    ...
    @Transactional
    public QuoteLineResponse execute(UUID projectId, UUID quoteId, UUID versionId, UUID lineId,
                                     String lineType, String name, String description,
                                     BigDecimal quantity, BigDecimal unitPrice, Integer displayOrder,
                                     Boolean clientVisible, String internalNote) {
        ...
        QuoteLineType type = lineType == null || lineType.isBlank() ? null
                : QuoteEnumParser.parseRequired(QuoteLineType.class, lineType,
                QuoteErrorCatalog.QUOTE_LINE_INVALID_QUANTITY.code(), "lineType");
        line = lines.save(line.update(type, name, description, quantity, unitPrice, displayOrder, clientVisible, internalNote));
        recalculator.recalculateAndSave(version);
        publisher.enqueueVersion(version, "QUOTE_LINE_UPDATED");
        activityLogger.logSuccess(QuoteEntityTypes.QUOTE_LINE, line.id(),
                QuoteActivityActions.QUOTE_LINE_UPDATED, "Quote line updated");
