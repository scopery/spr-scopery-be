package com.company.scopery.modules.projectnotification.shared.util;

import com.company.scopery.common.exception.ValidationException;

public final class ProjectNotificationEnumParser {
    private ProjectNotificationEnumParser() {}
