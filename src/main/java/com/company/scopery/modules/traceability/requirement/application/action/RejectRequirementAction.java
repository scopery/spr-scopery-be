...
import com.company.scopery.modules.traceability.requirement.application.command.RejectRequirementCommand;
...
@Component
public class RejectRequirementAction {
    private final RequirementRepository repo;
    private final TraceabilityAuthorizationService authorization;
    private final TraceabilityActivityLogger activityLogger;
    public RejectRequirementAction(RequirementRepository repo, TraceabilityAuthorizationService authorization, TraceabilityActivityLogger activityLogger) {
        this.repo=repo; this.authorization=authorization; this.activityLogger=activityLogger;
    }
    @Transactional
    public RequirementResponse execute(RejectRequirementCommand c) {
        ...
        var saved = repo.save(req.reject());
        activityLogger.logSuccess(TraceabilityEntityTypes.REQUIREMENT, saved.id(), TraceabilityActivityActions.REQUIREMENT_REJECTED, "Requirement rejected");
