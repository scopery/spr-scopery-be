...
@Component
public class DeleteUseCaseConditionAction {
    ...
    public DeleteUseCaseConditionAction(UseCaseRepository useCaseRepo,
    ...
    @Transactional
    public void execute(DeleteUseCaseConditionCommand c) {
        ...
        conditionRepo.deleteByIdAndUseCaseId(c.conditionId(), c.useCaseId());

        activityLogger.logSuccess(TraceabilityEntityTypes.USE_CASE_CONDITION, condition.id(),
                TraceabilityActivityActions.USE_CASE_CONDITION_DELETED, "Condition deleted: " + condition.id());
    }
}
