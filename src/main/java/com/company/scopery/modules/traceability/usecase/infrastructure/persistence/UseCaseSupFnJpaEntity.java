...
@Entity
@Table(name = TraceabilityTableNames.USE_CASE_SUPPORTING_FUNCTION)
@Getter
@Setter
@NoArgsConstructor
public class UseCaseSupFnJpaEntity {

    @EmbeddedId
    private UseCaseSupFnId id;
    ...
    public UseCaseSupFnJpaEntity(UseCaseSupFnId id) {
        this.id = id;
