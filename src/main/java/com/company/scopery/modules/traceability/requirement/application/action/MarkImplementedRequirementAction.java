...
import com.company.scopery.modules.traceability.requirement.application.command.MarkImplementedRequirementCommand;
...
@Component
public class MarkImplementedRequirementAction {
    private final RequirementRepository repo;
    private final TraceabilityAuthorizationService authorization;
    private final TraceabilityActivityLogger activityLogger;
    public MarkImplementedRequirementAction(RequirementRepository repo, TraceabilityAuthorizationService authorization, TraceabilityActivityLogger activityLogger) {
        this.repo=repo; this.authorization=authorization; this.activityLogger=activityLogger;
    }
    @Transactional
    public RequirementResponse execute(MarkImplementedRequirementCommand c) {
        ...
        var saved = repo.save(req.markImplemented());
        activityLogger.logSuccess(TraceabilityEntityTypes.REQUIREMENT, saved.id(), TraceabilityActivityActions.REQUIREMENT_IMPLEMENTED, "Requirement marked as implemented");
