...
public enum TraceabilityErrorCatalog implements ErrorCatalog {
    ...
    COMM_SPEC_NOT_FOUND("COMM_SPEC_NOT_FOUND", "Communication specification not found", HttpStatus.NOT_FOUND),
    COMM_SPEC_CODE_EXISTS("COMM_SPEC_CODE_ALREADY_EXISTS", "Communication specification code already exists", HttpStatus.CONFLICT),
    COMM_SPEC_NOT_READY("COMM_SPEC_NOT_READY", "Communication specification cannot be marked READY", HttpStatus.UNPROCESSABLE_ENTITY),
    FUNCTION_COMM_DUPLICATE("FUNCTION_COMM_DUPLICATE", "Communication already linked to this function", HttpStatus.CONFLICT),
    FUNCTION_COMM_NOT_FOUND("FUNCTION_COMM_NOT_FOUND", "Function-communication link not found", HttpStatus.NOT_FOUND),
