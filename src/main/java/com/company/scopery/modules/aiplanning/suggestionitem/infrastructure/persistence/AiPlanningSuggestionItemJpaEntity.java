...
public class AiPlanningSuggestionItemJpaEntity extends AuditableJpaEntity {
    ...
    @Column(name = "proposed_payload_json", nullable = false, columnDefinition = "jsonb") private String proposedPayloadJson;
    ...
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "apply_result_json", columnDefinition = "jsonb") private String applyResultJson;
