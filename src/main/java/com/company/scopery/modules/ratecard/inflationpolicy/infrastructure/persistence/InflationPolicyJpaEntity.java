...
@Entity
@Table(name = RateCardTableNames.INFLATION_POLICY, indexes = {
        @Index(name = "idx_rate_inflation_policy_scope", columnList = "scope"),
        @Index(name = "idx_rate_inflation_policy_workspace", columnList = "workspace_id"),
        @Index(name = "idx_rate_inflation_policy_status", columnList = "status")
})
public class InflationPolicyJpaEntity extends AuditableJpaEntity {
    ...
    @Column(name = "inflation_percent", nullable = false, precision = 8, scale = 4) private BigDecimal inflationPercent;
    @Column(name = "compound_frequency", nullable = false, length = 50) private String compoundFrequency;
